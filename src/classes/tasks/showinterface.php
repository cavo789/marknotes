...
class ShowInterface
{
    ...
    public static function Run()
    {
        ...
        "\nvar markdown = {};\n".
        "markdown.message={};\n".
        "markdown.message.allow_popup_please='".$aeSettings->getText('allow_popup_please','',true)."';\n".
        "markdown.message.apply_filter='".$aeSettings->getText('apply_filter','',true)."';\n".
        "markdown.message.apply_filter_tag='".$aeSettings->getText('apply_filter_tag','',true)."';\n".
        "markdown.message.button_encrypt='".$aeSettings->getText('button_encrypt','',true)."';\n".
        "markdown.message.button_save='".$aeSettings->getText('button_save','',true)."';\n".
        "markdown.message.button_save_done='".$aeSettings->getText('button_save_done','',true)."';\n".
        "markdown.message.button_save_error='".$aeSettings->getText('button_save_error','',true)."';\n".
        "markdown.message.cancel='".$aeSettings->getText('cancel','',true)."';\n".               
        "markdown.message.copy_clipboard_done='".$aeSettings->getText('copy_clipboard_done','',true)."';\n".
        "markdown.message.copy_link_done='".$aeSettings->getText('copy_link_done','',true)."';\n".
        "markdown.message.display_that_note='".$aeSettings->getText('display_that_note','',true)."';\n".
        "markdown.message.button_exit_edit_mode='".$aeSettings->getText('button_exit_edit_mode','',true)."';\n".
        "markdown.message.filesfound='".$aeSettings->getText('files_found','',true)."';\n".
        "markdown.message.json_error='".$aeSettings->getText('json_error','',true)."';\n".
        "markdown.message.ok='".$aeSettings->getText('OK','',true)."';\n".               
        "markdown.message.pleasewait='".$aeSettings->getText('please_wait','',true)."';\n".
        "markdown.message.search_no_result='".$aeSettings->getText('search_no_result','',true)."';\n".
        "markdown.message.tree_delete_file='".$aeSettings->getText('tree_delete_file','',true)."';\n".
        "markdown.message.tree_delete_folder='".$aeSettings->getText('tree_delete_folder','',true)."';\n".
        "markdown.message.tree_delete_file_confirm='".$aeSettings->getText('tree_delete_file_confirm','',true)."';\n".
        "markdown.message.tree_delete_folder_confirm='".$aeSettings->getText('tree_delete_folder_confirm','',true)."';\n".
        "markdown.message.tree_rename='".$aeSettings->getText('tree_rename','',true)."';\n".
        "markdown.message.tree_new_folder='".$aeSettings->getText('tree_new_folder','',true)."';\n".
        "markdown.message.tree_new_folder_name='".$aeSettings->getText('tree_new_folder_name','',true)."';\n".
        "markdown.message.tree_new_note='".$aeSettings->getText('tree_new_note','',true)."';\n".
        "markdown.message.tree_new_note_name='".$aeSettings->getText('tree_new_note_name','',true)."';\n".
