    ...
    public function process(string $task)
    {
        ...
        switch ($task) {
            ...
            case 'rename':
                ...
                //oldname=>$this->_rootFolder.$this->_settingsDocsFolder.utf8_decode(json_decode(urldecode(Functions::getParam('param', 'string', '', true)))),
                $newname=utf8_decode(json_decode(urldecode(\AeSecure\Functions::getParam('param2', 'string', '', true))));
