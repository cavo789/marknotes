...
class DOCX
{
    ...
    public static function add(&$buttons = null)
    {
        ...
        $title = $aeSettings->getText('export_'.self::$ext, 'Export the note as a Word document', true);
        ...
        if ($default === self::$ext) {
            // The default extension is docx ==> no need to mention the extension
