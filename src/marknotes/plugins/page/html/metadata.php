<?php
/**
 * Process <!--%META_DATA%--> and <!--%FAVICON%--> that can be added in the
 * template file (see /templates/html.php f.i.) and replace these tags by
 * content of meta.txt or favicon.txt
 */
