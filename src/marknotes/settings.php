...
class Settings
{
    ...
    */
    private function readSettings(array $params = null) : bool
    {
        ...
        $this->json = $this->loadJSON($params);
    ...
    */
    ...
    {
        return $this->json['files'][$node] ?? $default;
    } // function getFiles()
     ...
     *
     */
    public function getPlugins(string $info = '') : array
    {
        $arr = array();
        ...
        // If $info is like "plugins.options.export.copy", the "plugins." prefix
